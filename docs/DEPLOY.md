...
| `STRIPE_PRICE_ID_PRO` | Pro tier Stripe price ID ($7/mo) | Checkout returns 503 |
...
| `KH_MRR_PRO_CENTS` | Pro monthly price in cents (`700`) — the MRR figure in `/metrics` | MRR contribution from Pro subs is `0` |
